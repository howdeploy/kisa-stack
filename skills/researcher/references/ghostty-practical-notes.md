...
Особенно полезно, когда пользователь уже прислал свой config и хочет понять не «что ещё можно поставить», а «что реально улучшит опыт».
...
- Жёсткие CRT, Pip-Boy, scanlines, chromatic aberration чаще ухудшают читаемость long-form терминальной работы.
