---
name: css-graphics
description: Генерация CSS/SVG графики с рендером в PNG/JPG через Puppeteer. Use when пользователь просит "сделай графику", "нарисуй картинку", "создай изображение", "сгенерируй png", "css graphics", "css art", "svg graphic", "render to png", или дает референсное изображение для воссоздания в CSS/SVG.
metadata:
  hermes:
...
- Для JPEG используй расширение `.jpg` — автоматически уберет альфа-канал
